          ...
          <div className="row td_gap_y_30">
              ...
              <div className="td_card td_style_4 td_accent_bg">
                <div className="td_card_left">
                  <h3 className="td_fs_32 td_mb_16 td_white_color">
                    Creating Passive <span>Income</span> for Lawyers
                    {/* Expert <span>Instructor</span> Live Classes Here */}
                  </h3>
                  <p className="td_fs_18 td_white_color td_opacity_9 td_mb_30">
                    Are you a first-gen lawyer or someone looking for a platform to help & teach? DM your proposal to us.
                  </p>
            ...
            >
              <div className="td_card td_style_4 td_accent_bg">
                <div className="td_card_left">
                  <h3 className="td_fs_32 td_mb_16 td_white_color">
                    Want to <span>Intern</span> with us ?
              ...
              <SlickSlider {...settings}>
                <div className="td_slide">
                  <div className="td_brand td_style_1">
                    <img src="/wins/2.png" alt="Brand logo" />
                ...
                <div className="td_slide">
                  <div className="td_brand td_style_1">
                    <img src="/wins/1.png" alt="Brand logo" />
                    
                  </div>
                </div>
                <div className="td_slide">
                  <div className="td_brand td_style_1">
                    <img src="/wins/3.png" alt="Brand logo" />
                    
                  </div>
                </div>
                <div className="td_slide">
                  <div className="td_brand td_style_1">
                    <img src="/wins/4.png" alt="Brand logo" />
                ...
                <div className="td_slide">
                  <div className="td_brand td_style_1">
                    ...
                    <img src="/wins/5.png" alt="Brand logo" />
