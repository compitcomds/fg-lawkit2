    ...
    <section id="about">
      ...
      <div className="container">
        <div className="row td_gap_y_40">
          ...
          >
            {/* td_section_heading td_style_1 td_mb_40 the class is used to style the heading */}
            <div className="">
              <p className="td_section_subtitle_up td_fs_18 td_semibold td_spacing_1 td_mb_10 text-uppercase td_accent_color">
                <i></i>About us<i></i>
              </p>
              <h2 className="td_section_title td_fs_48 td_mb_24">
                What is Wrong with Legal EdTech in India?
              </h2>

              <p className="td_section_subtitle td_fs_18 mb-0">
                The Dilemma We Observed: Quality comes at a high cost, and affordability often means sacrificing quality. Thus, at FG-LawKit, we act as a bridge where the educator,
                while retaining the IP under their name, creates content for you
                - and we ensure it’s affordable
              </p>
            </div>
            <div className="td_mb_40 position-relative">
              <ul className="td_list td_style_2 td_fs_24 td_medium td_heading_color td_mp_0">
                <li>
                  ...
                  Learn from Exam Toppers Themselves
