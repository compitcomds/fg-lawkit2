...
export const CoursesAllContainer = ({ children }) => {
  return (
    <section>
      <div className="td_height_50 td_height_lg_10" />
      <div className="container">
        ...
        >
          ...
          <div className="td_section_heading_right">
            We’ve personally bought and explored all the popular courses, and
            now we’re bringing the best to you
          </div>
        </div>
        {/* header */}
