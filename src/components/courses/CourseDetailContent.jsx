...
export const CourseDetailContent = () => {
  const [activeTab, setActiveTab] = useState("td_tab_1");
    ...
    const fetchCourse = async () => {
      try {
        ...
        const { data } = await axios.get(
          `${config.backendApiUrl}/api/meta-datas?fields[0]=handle&fields[1]=meta_data&fields[2]=updatedAt&filters[meta_format][documentId][$eq]=ojz6l3nldu1hzpjultyqros9&filters[handle][$eq]=${slug}&${config.appendTenentId}`
        );
  ...
  if (!course) {
    return (
      <h2
        className="container"
        style={{ color: "red", marginTop: "80px", textAlign: "center" }}
      >
        Uh Oh! Course not found.
      </h2>
    );
  }
  ...
  return (
    <>
      <Helmet>
        <title>{course.meta_data.title} | FG Lawkit</title>
        <meta name="description" content={course.meta_data.excerpt} />
        <meta name="keywords" content={course.meta_data.tag} />
        <meta property="og:title" content={course.meta_data.title} />
        <meta
          property="og:description"
          content={course.meta_data.course_overview
            ?.replace(/<[^>]+>/g, "")
            .slice(0, 160)}
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={course.meta_data.thumbnail} />
              ...
              <div className="td_course_details">
                <div className="embed-responsive embed-responsive-16by9 td_radius_10 td_mb_40">
                  <iframe
                    ...
                    src={course.meta_data.intro_video_url}
                    allowFullScreen
                    title="Course video"
                  ></iframe>
                </div>
                <span className="td_course_label td_mb_10">
                  {course.meta_data.tag}
                </span>
                <h2 className="td_fs_48 td_mb_30">{course.meta_data.title}</h2>
                <div className="td_course_meta td_mb_40">
                  <div className="td_course_avatar">
                    <CourseImage
                      imageId={course.meta_data.teacher_image}
                      title={course.meta_data.teacher_name}
                    />
                    <p className="td_heading_color mb-0 td_medium">
                      <span className="td_accent_color">Trainer: </span>
                      <Link to="#">{course.meta_data.teacher_name}</Link>
                    </p>
                  </div>
                ...
                <div className="td_tabs td_style_1 td_mb_50">
                  <ul className="td_tab_links td_style_2 td_type_2 td_mp_0 td_medium td_fs_20 td_heading_color">
                    <li className={activeTab === "td_tab_1" ? "active" : ""}>
                      <a
                        href="#td_tab_1"
                        onClick={(e) => {
                          e.preventDefault();
                          setActiveTab("td_tab_1");
                        }}
                      >
                        Overview
                      </a>
                    </li>
                    <li className={activeTab === "td_tab_2" ? "active" : ""}>
                      <a
                        href="#td_tab_2"
                        onClick={(e) => {
                          e.preventDefault();
                          setActiveTab("td_tab_2");
                        }}
                      >
                        Curriculum
                      </a>
                    </li>
                    <li className={activeTab === "td_tab_3" ? "active" : ""}>
                      <a
                        href="#td_tab_3"
                        onClick={(e) => {
                          e.preventDefault();
                          setActiveTab("td_tab_3");
                        }}
                      >
                        Instructor
                      </a>
                    </li>
                    <li className={activeTab === "td_tab_4" ? "active" : ""}>
                      <a
                        href="#td_tab_4"
                        onClick={(e) => {
                          e.preventDefault();
                          setActiveTab("td_tab_4");
                        }}
                      >
                        Reviews
                      </a>
                    ...
                    >
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: course.meta_data.course_overview,
                        }}
                      ></div>
                    </div>
                    <div
                      className={`td_tab ${
                        activeTab === "td_tab_2" ? "active" : ""
                      }`}
                      id="td_tab_2"
                    >
                      ...
                      <div
                        className="mb-0"
                        dangerouslySetInnerHTML={{
                          __html: course.meta_data.curriculum,
                        }}
                      ></div>
                    </div>
                    <div
                      className={`td_tab ${
                        activeTab === "td_tab_3" ? "active" : ""
                      }`}
                      id="td_tab_3"
                    >
                      ...
                      <div
                        className="mb-0"
                        dangerouslySetInnerHTML={{
                          __html: course.meta_data.instructor,
                        }}
                      ></div>
                    </div>
                    <div
                      className={`td_tab ${
                        activeTab === "td_tab_4" ? "active" : ""
                      }`}
                      id="td_tab_4"
                    >
                      <h2 className="td_fs_48 td_mb_20">Courses Reviews</h2>
                      <ul className="mb-0">
                        {course.meta_data.reviews?.map((review, index) => (
                ...
                <h2 className="td_fs_48 td_mb_30">What you will Learn it?</h2>
                <ul className="td_list td_style_2 td_type_2 td_fs_18 td_medium td_heading_color td_mp_0">
                  {course.meta_data.course_outline?.map((point, index) => (
                    <li key={index}>
                      <svg
                ...
                <div className="td_requirements_list td_medium td_fs_18">
                  {course.meta_data.requirements?.map((req, index) => (
                    <span className="td_requirement" key={index}>
                      {req}
                    </span>
                  ))}
                </div>
              ...
              <div className="td_card td_style_7">
                ...
                <ul className="td_card_list td_mp_0 td_fs_18 td_medium">
                  ...
                  <li>
                    ...
                    <span className="td_semibold td_accent_color">
                      {course.meta_data.no_of_students}
                    </span>
                  </li>
                  <li>
                    <span>
                  ...
                  <li>
                    ...
                    <span className="td_semibold td_accent_color">
                      {course.meta_data.certification ? "Yes" : "No"}
                    </span>
                  </li>
                </ul>
                <div className="td_height_30 td_height_lg_30" />
